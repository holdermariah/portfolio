...
export const PROJECTS: Project[] = [
	{
		...
		subProjects: [
			...
			{
				id: 'Multivista Project 2',
				title: 'Flyer and Magazine Ad Examples',
				year: 2021 - 2025,
				thumbnail: getImagePath('images/multivista/Multivista Magazine Ad.png'),
				category: 'Print Design',
				description: 'Flyer and magazine ad design created for Multivista',
				sections: [
					{
						id: 'cover',
						title: '',
					...
					},
					{
						...
						title: '',
						content: '',
						images: [getImagePath('images/multivista/Multivista Magazine Ad.png')],
					},
					{
						id: 'content-2',
						title: '',
						content: '',
						images: [getImagePath('images/multivista/Multivista Flyer.png')],
					},
				],
				tools: ['Photoshop', 'Illustrator'],
			},
			{
				id: 'Hexagon Projects',
				title: 'Hexagon Projects',
				year: 2025,
				thumbnail: getImagePath('images/multivista/Booth Hexagon.pdf'),
				category: 'Trade Show Materials',
				description: 'Booth, Banner and Brochure material created for Hexagon',
				sections: [
					{
						id: 'cover',
						title: '',
						content: '',
						images: [getImagePath('images/multivista/Booth Hexagon.pdf')],
					},
					{
						id: 'text',
						title: '',
						content: "Multivista it's a company under Hexagon's umbrella. In my last year working for Multivista I was requested to create assest with Hexagon's brend indentity too. These material was used in some tradeshows attended by Hexagon.",
					},
					{
						id: 'content',
						title: '',
						content: '',
						images: [
							getImagePath('images/multivista/Hexagon Banner.png'),
							getImagePath('images/multivista/Hexagon Brochure.pdf'),
						],
					},
				],
				tools: ['Photoshop', 'Illustrator'],
